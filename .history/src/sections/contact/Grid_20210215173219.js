...
const servicesLeft = [
  ...
  {
    title: "Nous suivre ",
    text: ' "https://www.facebook.com/pages/category/Community-Organization/PAD-Business-Network-Foundation-342843433036526">',
    images:['/static/facebook.png','/static/twitter.png','/static/instagram.png']
  },
]
...
let service = props.service;
 ...
 let getImage = (service) => {
    return service.images.map((path) => {
      return (
        <a href={service.text}>
          <img src={path} alt=""/>
        </a>
