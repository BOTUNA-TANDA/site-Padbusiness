...
const servicesLeft = [
  ...
  },
  {
    title: "Nous soutenir /Donate  ",
    text:
      "pad.business.network@gmail.com <br/> BE82 0689 3456 0368 - BIC:GKCCBEBB",
  },
  {
    title: "Mobile",
    text: " +32 484 52 32 63 <br/> +243 822 77 07 04",
  ...
  {
    title: "Nous suivre ",
    text:' <a target="_blank" href="https://www.facebook.com/pages/category/Community-Organization/PAD-Business-Network-Foundation-342843433036526/">',
    images: ["/public/static/facebook.png"],
  },
]

function ServiceItem(props) {
  let images = props.service?.images.length > 0 ? props.images : null
  ...
  return (
    <ServiceListItem className={"space-service-item"}>
      <Text
        ...
        fontWeight={800}
        color={"#F78240"}
        className={"space-service-item-plus"}
      >
        +
      </Text>
      <Text
        ...
        sizeMd={0.6}
        fontWeight={600}
        className={"space-service-item-text"}
      >
        {props.service}
      </Text>
    </ServiceListItem>
